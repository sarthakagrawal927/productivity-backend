...
const (
	EXERCISE_ISOLATED uint = iota + 1
	EXERCISE_COMPOUND
	EXERCISE_CARDIO
	EXERCISE_FLEXIBILITY
)

const (
	EXERCISE_TARGET_CHEST uint = iota + 1
	EXERCISE_TARGET_BACK
	EXERCISE_TARGET_SHOULDERS
	EXERCISE_TARGET_BICEPS
	EXERCISE_TARGET_TRICEPS
	EXERCISE_TARGET_FOREARMS
	EXERCISE_TARGET_ABS
	EXERCISE_TARGET_LOWER_BACK
	EXERCISE_TARGET_QUADS
	EXERCISE_TARGET_HAMSTRINGS
	EXERCISE_TARGET_CALVES
)
